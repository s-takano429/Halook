...
// Class //
// ///////////////////////////////////////////////////////
halook.NodeInfoParentView = wgp.AbstractView
		.extend({
			initialize : function(argument) {
				...
				this.graphIds = argument["graphIds"];
				...
				this._addGraphDivision(this.graphIds);
...
//				this.setEventOnDualSlider(dualSliderView, nodeView);
			...
			_addGraphDivision : function(graphId) {
				...
				$("#" + this.$el.attr("id")).append(
						'<div id="' + graphId + '"></div>');
				$('#' + graphId).css(halook.nodeinfo.parent.css.graphArea);
