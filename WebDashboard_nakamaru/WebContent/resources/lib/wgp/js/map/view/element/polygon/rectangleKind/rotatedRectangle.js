...
/*
    ...
    // 左上ポジション
    var firstPosition = new Position(args.centerX + args.origin.x, args.centerY - args.origin.y);
    positionArray.push(firstPosition);
    // 右上ポジション
    var secondPosition = new Position(args.topEdge.x, -args.topEdge.y);
    positionArray.push(secondPosition);
    // 左下ポジション
    var thirdPosition = new Position(args.leftEdge.x, -args.leftEdge.y);
    positionArray.push(thirdPosition);
    // 右下ポジション
    var forthPosition = new Position(-args.topEdge.x, args.topEdge.y);
