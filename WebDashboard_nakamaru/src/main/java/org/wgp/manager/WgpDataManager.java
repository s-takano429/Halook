...
public class WgpDataManager {
	 ...
	 */
	public WgpDataManager(Map<String, Map<String, Object>> initMap){
		dataMap = initMap;
	}
	 ...
	 */
	public void initDataMap(String dataGroupId, Map<String, Object> unitMap){
	 ...
	 * @param unitMap set target.
	 */
	public Object getData(String dataGroupId, String objectId){
	 ...
	 */
	public void setData(String dataGroupId, String objectId, Object wgpData){
		Map<String, Object> unitMap = this.dataMap.get(dataGroupId);
		if (unitMap == null) {
	 ...
	 * @param objectId object id with group of dataGroupId
	 */
	public void removeData(String dataGroupId, String objectId) {
		Map<String, Object> unitMap = this.dataMap.get(dataGroupId);
		if (unitMap == null) {
			return;
		}
	...
	public void updateData(String dataGroupId, String objectId, Object wgpData) {
		Map<String, Object> unitMap = this.dataMap.get(dataGroupId);
		if (unitMap == null) {
			return;
		}
