...
import jp.co.acroquest.endosnipe.web.dashboard.entity.MeasurementData;
import jp.co.acroquest.endosnipe.web.dashboard.entity.MeasurementDetailData;
import jp.co.acroquest.endosnipe.web.dashboard.entity.MeasurementNotifyEntity;
...
import jp.co.smg.endosnipe.common.entity.MeasurementDetail;
import jp.co.smg.endosnipe.common.entity.ResourceData;
import jp.co.smg.endosnipe.common.jmx.JMXManager;
import jp.co.smg.endosnipe.communicator.TelegramListener;
import jp.co.smg.endosnipe.communicator.accessor.ResourceNotifyAccessor;
...
public class CollectorListener implements TelegramListener
{
     ...
     */
    public CollectorListener(MessageSender messageSender, int agentId, String databaseName)
    {
    ...
    public Telegram receiveTelegram(Telegram telegram)
    {
                ...
                && header.getByteRequestKind() == TelegramConstants.BYTE_REQUEST_KIND_RESPONSE)
        {
            ResourceData resourceData =
                                        ResourceNotifyAccessor.createResourceData(
                                                                                  telegram,
                                                                                  this.databaseName_);
     ...
     */
    private void sendNotifyEntry(Map<Integer, List<MeasurementData>> measurementDataMap,
            Map<String, MeasurementSetting> matchSettingMap)
    {
    ...
    private Map<Integer, List<MeasurementData>> createMeasurementDataMap(ResourceData resourceData)
    {
        Map<Integer, List<MeasurementData>> measurementDataMap =
                                                                 new HashMap<Integer, List<MeasurementData>>();
        Map<Integer, jp.co.smg.endosnipe.common.entity.MeasurementData> measurementMap =
                                                                                         resourceData.getMeasurementMap();
        //max
        jp.co.smg.endosnipe.common.entity.MeasurementData systemPhisycalmemMaxMeasurementData =
        ...
        for (jp.co.smg.endosnipe.common.entity.MeasurementData measurementData : measurementMap.values())
        {
    ...
    private MeasurementNotifyEntity createMeasurementEntity(
            Map<Integer, List<MeasurementData>> measurementDataMap, int graphId,
            Map<Integer, String> measuremtTypeMap)
    {
     ...
     * @param itemName 項目名
     */
    private void setJMXMeasurementData(Map<Integer, List<MeasurementData>> measurementDataMap,
            List<MeasurementData> graphDataList, String itemName)
    {
     ...
     */
    private MeasurementSetting getMatchSetting(MeasurementSetting clientSetting,
            Set<Integer> measurementTypeSet)
    {
     ...
     * @return　クライアントの設定情報から計測項目IDの一致する設定情報
     */
    private Map<Integer, String> getClientMeasurementTypeSet(Integer graphId,
            MeasurementSetting clientSetting)
    {
